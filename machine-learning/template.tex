...
\qs{}{What is Machine Learning? Where it fits?}
\sol Machine Learning is a way to get computers to do useful things without having to write explicit rules for every situation.

\begin{eli5}
	Imagine teaching of our little sibilings to recognize a dog.You don't hand them a rule book that says four legs,fur,books.\\
	you just show them a 100 dogs and say \textbf{"dog!"} enough times,and they figure it out the pattern on its own.
\end{eli5}

Tradational Programming work by giving a computer a precise set of instuction.

\begin{center}
	If this ----------------------------> Then that
\end{center}

This Work Beautifully for things you can fully describe. Finding the shortest driving route?
\chapter{}
